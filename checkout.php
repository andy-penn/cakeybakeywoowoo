...
if ( $PaymentOption == "PayPal")
{
        ...
        //'------------------------------------
        $returnURL = "http://cakeybakeywoowoo.co.uk/handle_upgrade.php";
        ...
        //' This is set to the value entered on the Integration Assistant 
        //'------------------------------------
        $cancelURL = "http://cakeybakeywoowoo.co.uk/upgrade.php";
		...
		$items = array();
		$items[] = array('name' => '1 Year Premium Account', 'amt' => $paymentAmount, 'qty' => 1);
